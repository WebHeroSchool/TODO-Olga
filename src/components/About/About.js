    ...
    const Description = (<div className={styles.info}>
      ...
      <div>
        ...
        <div className={styles.projects}>
          <div className={styles.projects_title}>Мои проекты:</div>
          <div className={styles.projects_ul}>
            <div>Сайт <a href='https://mylnikovao.github.io/Loco/'>https://mylnikovao.github.io/Loco/</a></div>
            <div>Игра <a href='https://mylnikovao.github.io/Game/'>https://mylnikovao.github.io/Game/</a></div>
            <div>Прогноз погоды <a href='https://mylnikovao.github.io/Weather-forecast/'>https://mylnikovao.github.io/Weather-forecast/</a></div>
          </div>
        </div>
